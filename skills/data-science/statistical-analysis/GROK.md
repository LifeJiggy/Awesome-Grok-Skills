...
- Report effect sizes alongside p-values Ã¢â‚¬â€ p < 0.05 with d = 0.1 is practically meaningless
...
### Bayesian Analysis
- Conduct prior sensitivity analysis Ã¢â‚¬â€ vary priors and check if conclusions change
