...
- Examine residuals for remaining patterns Ã¢â‚¬â€ they should be white noise
...
- Report prediction intervals, not just point forecasts Ã¢â‚¬â€ uncertainty matters
...
- Validate anomalies manually Ã¢â‚¬â€ automated detection always has false positives
...
- Consider lag Ã¢â‚¬â€ change points may be detected with a delay in real-time systems
