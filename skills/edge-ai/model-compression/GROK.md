...
print(f"Size: {result.original_mb:.1f} Ã¢â€ â€™ {result.compressed_mb:.1f} MB")
print(f"Accuracy: {result.original_accuracy:.2%} Ã¢â€ â€™ {result.compressed_accuracy:.2%}")
...
print(f"Parameters: {result.original_params:,} Ã¢â€ â€™ {result.pruned_params:,}")
...
Ã¢â€â€š   Original  Ã¢â€â€šÃ¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Â¶Ã¢â€â€š  Analysis    Ã¢â€â€šÃ¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Â¶Ã¢â€â€š  Strategy   Ã¢â€â€š
Ã¢â€â€š   Model     Ã¢â€â€š     Ã¢â€â€š  Profiling   Ã¢â€â€š     Ã¢â€â€š  Selection  Ã¢â€â€š
...
Ã¢â€â€š  Compression    Ã¢â€â€šÃ¢â€”â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â€š  Compression Planner     Ã¢â€â€š
Ã¢â€â€š  Execution      Ã¢â€â€š     Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Ëœ
...
Ã¢â€â€š  Validation     Ã¢â€â€šÃ¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Â¶Ã¢â€â€š  Deployment Ã¢â€â€š
Ã¢â€â€š  & Benchmark    Ã¢â€â€š     Ã¢â€â€š  Package    Ã¢â€â€š
...
| Term | Definition |
|------|------------|
| **Quantization** | Reducing numerical precision (FP32Ã¢â€ â€™INT8) |
...
for result in results:
    ...
    print(f"  Size: {result.original_mb:.1f} MB Ã¢â€ â€™ {result.compressed_mb:.1f} MB")
    print(f"  Latency: {result.original_latency_ms:.1f}ms Ã¢â€ â€™ {result.compressed_latency_ms:.1f}ms")
    print(f"  Accuracy: {result.original_accuracy:.2%} Ã¢â€ â€™ {result.compressed_accuracy:.2%}")
```
