...
┌────────────────▼────────────────────────┐
│          Onboarding Layer               │
│   (Registration, Training, Orientation) │
└────────────────┬────────────────────────┘
                 │
┌────────────────▼────────────────────────┐
│          Engagement Layer               │
...
```
Recruit → Register → Onboard → Engage → Retain → Recognize
   │          │          │         │         │          │
   ▼          ▼          ▼         ▼         ▼          ▼
...
```
Event Planning → Volunteer Recruitment → Shift Assignment → Execution → Follow-up
       │                │                    │              │           │
       ▼                ▼                    ▼              ▼           ▼
...
- `volunteers_active_total` — active volunteer count.
- `volunteers_hours_logged_total` — total hours logged.
- `volunteers_events_attended_total` — events attended.
- `volunteers_retention_rate` — volunteer retention rate.
